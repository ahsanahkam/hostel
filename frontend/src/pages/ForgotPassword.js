/**
 * Forgot Password Page (View Layer)
 * ==================================
 * 
 ...
 * ---------------------------
 * Step 1: Enter email → Sends 6-digit code to email
 * Step 2: Enter code  → Verifies the reset code
 * Step 3: New password → Sets new password and redirects to login
 * 
 * API Endpoints Used:
 * - POST /api/users/request-reset/     → Send reset code
 * - POST /api/users/verify-code/       → Verify code
 * - POST /api/users/reset-password-with-code/ → Set new password
 */
...
function ForgotPassword() {
     ...
     * Sets new password after code verification
     */
